...
def _build_settings(cfg: dict) -> SettingsModel:
    ...
    settings = SettingsModel(
        ...
        pdf=PDFSettings(
            no_dual=bool(cfg.get("no_dual", False)),
            ...
            pages=str(cfg["pages"]) if cfg.get("pages") else None,
            only_include_translated_page=bool(cfg.get("only_include_translated_pages", False)),
